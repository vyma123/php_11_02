...
function insert_product(object $pdo, string $product_name, string $sku, string $price){
    $data = [
        ...
        $query = "INSERT INTO products (product_name, sku, price, date) VALUES (:product_name, :sku, :price, NOW())";
